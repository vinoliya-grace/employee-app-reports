...
function checkAll(ele) {
     ...
     console.log("success in selecting all the check box");
 }
      ...
      if (this.responseText == "No recent exports" || this.responseText == "no reports for user") {
        ...
        for (var key in reports) {
          ...
          if (repIndex > 0) {
            ...
            /*var userid = report.substring(83);*/
            var subArr = sub0.split("\\");
            var uName = subArr[1];
            /*var username = (uName.split("\\"))[0]; */
            // alert(username);
            var sub1 = sub0.substring(sub0.indexOf("EmpAppUsageStats-"), sub0.length);
            var arr = sub1.split("-");
            var cname = arr[1];            
            ...
            tReportUserIdElem.innerHTML = uName;
